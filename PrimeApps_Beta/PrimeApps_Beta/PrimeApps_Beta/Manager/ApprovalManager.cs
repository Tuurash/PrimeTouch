...
namespace PrimeApps_Beta.Manager
{
    class ApprovalManager
    {
        ...
        internal static int UpdateAdvanceDoStatus(string documentNo, string lcNo, string companyName, string status)
        {
            return new Mkt_DataGateway().UpdateAdvanceDoStatus(documentNo, lcNo, companyName, status);
        }

        internal static int UpdateDoStatus(string documentNo, string lcNo, string companyName, string status)
        {
            return new Mkt_DataGateway().UpdateDoStatus(documentNo, lcNo, companyName, status);
        }
    }
}
